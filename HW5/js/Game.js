...
Follower.prototype.update = function() {
    ...
    return {
        ...
        create: function () {
            ...
            game.add.tileSprite(0, 0, 4800, 3000, 'citybg');
            ...
            game.weapon.bulletAngleOffset = 100;
            game.weapon.bulletSpeed = 100;
            game.weapon.fireRate = 0.3;
            ...
            game.chargebar = game.add.sprite(10, 10, 'chargebar');
            game.healthbar = game.add.sprite(150, 10, 'healthbar');
            game.x02 = game.add.sprite(170, 430, 'x02welcome');
            game.planetx01 = game.add.sprite(1000, 130, 'planetx01');
            game.x02.fixedToCamera = true;
            game.player = game.add.sprite(100, 300, 'spaceship');
            game.chargebar.fixedToCamera = true;
            ...
            for (var i = 0; i < 5; i++)
            {
                ...
                //game.physics.arcade.overlap(game.building, game.player, destroyBuilding, null, game);
            ...
            game.timerText = game.add.text(600, 10, "Xeltors: 0", style );
            game.timerText.fixedToCamera = true;

            //game.currentplanettext = game.add.text(300, 550, "Welcome to Galaxy X02", style)
            //game.currentplanettext.fixedToCamera = true;
