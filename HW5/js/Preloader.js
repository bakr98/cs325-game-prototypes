...
GameStates.makePreloader = function( game ) {
    ...
    return {
        ...
        preload: function () {
            ...
            game.load.image('planetx01', 'assets/planet3052.png')
            game.load.image('cat', 'assets/phaser.png');
            ...
            game.load.image('chargebar', 'assets/chargebar.png');
            game.load.image('x02welcome', 'assets/pixel-speech-bubble.png');
            ...
            game.load.audio('ingame', ['assets/ingamex02.mp3']);
