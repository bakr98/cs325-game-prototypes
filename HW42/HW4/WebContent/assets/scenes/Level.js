...
class Level extends Phaser.Scene {
	...
	_create() {
		...
		this.add.myTilemap(321.23026, 479.99997, "Main Layer");
		...
		var acorn_8 = this.add.acorn(352.10352, 589.6016, "atlas", "acorn-1");
		
		var acorn_7 = this.add.acorn(224.0, 608.0, "atlas", "acorn-1");
		
		var acorn_6 = this.add.acorn(564.93475, 649.8833, "atlas", "acorn-1");
		...
		var player = this.add.player(349.2729, 734.42786, "atlas", "player-idle-1");
